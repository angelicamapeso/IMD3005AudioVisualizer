...
void ofApp::setup(){
	...
	//sound player setup
	//soundPlayer.load("BLACKPINK");		<--THE BLACKPINK SONG
	soundPlayer.setLoop(true);
	soundPlayer.play();

	//audio analyser
	audioAnalyser.init(&soundPlayer, 36);
...
void ofApp::update(){
	...
	position = soundPlayer.getPosition() * 209;
}
...
void ofApp::draw(){
	...
	float tone1 = audioAnalyser.getLinearAverage(4);
	float tone2 = audioAnalyser.getLinearAverage(5);
	float tone3 = audioAnalyser.getLinearAverage(6);
	float tone4 = audioAnalyser.getLinearAverage(7);

	//map linear averages
	float mappedBass = ofMap(bass, 100, 260, 0.0, 1.0, true);

	float mappedTone1 = ofMap(tone1, 30, 40, 0.0, 1.0, true);
	float mappedTone2 = ofMap(tone2, 30, 40, 0.0, 1.0, true);
	float mappedTone3 = ofMap(tone3, 60, 70, 0.0, 1.0, true);
	...
	//background
	if ((position >= 8.2 && position <8.4 )
		|| (position >= 15 && position < 15.2)
		|| (position >= 35.5 && position < 35.7)
		|| (position >= 93.5 && position < 93.7)
		|| (position >= 175.9 && position < 176.1)) {
		ofSetBackgroundColor(ofColor::black);
	}
	else if ((position >= 8.4 && position < 8.6)
		|| (position >= 15.2 && position < 15.4)
		|| (position >= 35.7 && position < 35.9)
		|| (position >= 93.7 && position < 93.9)
		|| (position >= 176.1 && position < 176.3)) {
		ofSetBackgroundColor(140,33,88);
	}
	else {
	...
	//graphics
	ofFill();
	if (position >= 0 && position < 8.9) {
		//intro phase1
		intro(false);
	}
	else if (position >= 8.9 && position < 22.5) {
		//intro phase2
		intro(true);
	}
	else if (position >= 22.5 && position < 36) {
		//verse1 phase1
		verse1(false);
	}
	...
	else if (position >= 50 && position < 64.5) {
		//prechor phase1
		prechorus1(false);
	}
	else if (position >= 64.5 && position < 77.3) {
		//prechor phase2
		prechorus1(true);
	}
	else if (position >= 77.3 && position < 94) {
		//chor 1
		chorus1();
	}
	else if (position >= 94 && position < 107.9) {
		//verse2 
		verse2();
	}
	else if (position >= 107.9 && position < 121.8) {
		//prechor phase1
		prechorus2(false);
	}
	else if (position >= 121.8 && position < 135.4) {
		//prechor phase2
		prechorus2(true);
	}
	else if (position >= 135.4 && position < 149) {
		//chor2
		chorus2();
	}
	else if (position >= 149 && position < 162.8) {
		//bridge phase1
		bridge(false);
	}
	else if (position >= 162.8 && position < 174.7) {
		//bridge phase2
		bridge(true);
	}
	else if (position >= 176.4 && position < 190.1) {
		//chor3 phase1
		chorus3(false);
	}
	else if (position >= 190.1 && position < 204.3) {
		//chor3 phase2
		chorus3(true);
	}
